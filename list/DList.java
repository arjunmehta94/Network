...
public class DList extends List {
  ...
  public DList() {
    ...
    this.head = this.newNode(null, null, null, null);
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode obj = newNode(item, this, this.head, this.head.next);
      head.next.prev = obj;
      head.next = obj;
      size++;
  }
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode obj = newNode(item, this, this.head.prev, this.head);
    head.prev.next = obj;
    head.prev = obj;
    size++;
  }
